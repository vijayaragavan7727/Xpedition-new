...
export default function WorldRenderer(props?: WorldRendererProps) {
  ...
  if (!storeData || !gameWorldData) {
    return (
      <div className="w-full h-full min-h-[350px] flex items-center justify-center bg-[#0D1F12] font-mono text-xs text-emerald-400">
  ...
  return (
    <div className="relative w-full h-full min-h-[350px] overflow-hidden select-none bg-[#0D1F12]">
