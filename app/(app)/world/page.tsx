...
export default function WorldPage() {
  ...
  if (!storeData || !gameWorldData) {
    return (
      <div className="w-full h-full min-h-screen flex items-center justify-center bg-[#112417] font-mono text-xs text-emerald-400">
        <div className="flex flex-col items-center gap-3">
          <div className="w-8 h-8 border-2 border-emerald-400 border-t-transparent rounded-full animate-spin" />
          <span>Framing Strategy Base...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full h-full min-h-[100dvh] relative select-none overflow-hidden bg-[#112417]">
